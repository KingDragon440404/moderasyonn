...
if(!["789463728315826184", "839950590083203172"].some(role => message.member.roles.cache.get(role)) && (!message.member.hasPermission("ADMINISTRATOR"))) 

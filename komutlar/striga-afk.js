...
exports.run = async (client, message, args) => {
  ...
  if (!args[0]) {
   ...
   message.channel.send(new MessageEmbed().setColor('BLACK').setDescription(`<a:hydratac:789369824249643009> ${kullanıcı} Başarıyla Afk Oldunuz Afk Olmanızın Sebebi: **${ramo}**`));

...
exports.run = async (client, message, args, ayar, emoji) => {
    let boosterrol = "789206634429677619" //boost rolü idsi
    let kanalid = "789194953880109056" //kullana bileceginiz kanal id (misal commands - bot komutlar)
...
.setTimestamp()
.setFooter(`HYDRA`, "https://cdn.discordapp.com/emojis/785950806384836619.gif?v=1%22"))
message.react(iptal);
